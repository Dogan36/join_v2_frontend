<template>
  <div class="helpContent">
    ...
    <p class="help-text">
    Welcome to the help page for Join, your guide to using our kanban project
    management tool. Here, we'll provide an overview of what Join is, how it can
    benefit you, and how to use it.
  </p>
  ...
  <p class="help-text">
    ...
    Join leverages the principles of kanban to help users manage their tasks and
    ...
    is not intended for extensive business usage. While we strive to ensure the
    best possible user experience, we cannot guarantee consistent availability,
    reliability, accuracy, or other aspects of quality regarding Join.
  </p>

  <h2 class="help-subtitle">How to use it</h2>
  <p class="help-text">
  ...
  <div class="steps">
    <div class="step">
      ...
      <div class="step-content">
        <h3 class="step-title">Exploring the Board</h3>
        <p>
    ...
    <div class="step">
      ...
      <div class="step-content">
        <h3 class="step-title">Creating Contacts</h3>
        <p>
          In Join, you can add contacts to collaborate on your projects.
          Go to the "Contacts" section, click on "New contact", and fill in
          the required information. Once added, these contacts can be assigned
    ...
    <div class="step">
      ...
      <div class="step-content">
        <h3 class="step-title">Adding Cards</h3>
        <p>
    ...
    <div class="step">
      ...
      <div class="step-content">
        <h3 class="step-title">Moving Cards</h3>
        <p>
    ...
    <div class="step">
      ...
      <div class="step-content">
        <h3 class="step-title">Deleting Cards</h3>
        <p>
          ...
          mail@dogan-celik.com. We're here to help you!
        </p>
      </div>
    </div>
  </div>
